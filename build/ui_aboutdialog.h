...
"Copyright &copy; 2011-YYYY The Maylolcoin developers"));
    ...
    {
        AboutDialog->setWindowTitle(QApplication::translate("AboutDialog", "About Maylolcoin", 0));
        label->setText(QApplication::translate("AboutDialog", "<b>Maylolcoin</b> version", 0));
