...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Maylolcoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
   // {"maylolcointools.com", "13.230.123.103"},
    {"maylolcointools.com", "119.205.233.188"},
    {NULL, NULL}
};

static const char *strTestNetDNSSeed[][2] = {
    {"maylolcointools.com", "testnet-seed.maylolcointools.com"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Maylolcoin is probably already running."), addrBind.ToString().c_str());
        else
